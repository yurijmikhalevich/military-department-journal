...
private:
    /**
     * @brief execQueryAndReturnId Executes query and returns lastInsertId. If used with non-insert statement
     * behaviour is undefined. It throws exception if execution of query is errored.
    ...
    /**
     * @brief execQueryAndReturnId Overloaded version of execQueryAndReturnId(QSqlQuery *query). Used to pass query as
     * QString
     * @param query Pointer to a QSqlQuery object
